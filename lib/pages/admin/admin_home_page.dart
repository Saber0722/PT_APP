                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.pushNamed(context, adminAddUserPageRoute);
                    },
                    child: Text(
                      'Add',
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.pushNamed(context, adminViewAllUserPageRoute);
                    },
                    child: Text(
                      'View/Edit',
                      style: TextStyle(fontSize: 18, color: Colors.white), // Change text color to white
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.pushNamed(context, adminDeletePageRoute);
                    },
                    child: Text(
                      'Delete',
                      style: TextStyle(fontSize: 18, color: Colors.white), // Change text color to white
