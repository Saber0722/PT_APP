...
import 'package:modernlogintute/pages/admin/view_edit_page.dart';
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: IconButton(
                    icon: Icon(Icons.edit), // edit icon here
                    onPressed: () {
                      // Navigate to the ViewEditUserPage with the user's data
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ViewEditUserPage(
                            docIdToEdit: docId,
                            userData: data,
                          ),
                        ),
