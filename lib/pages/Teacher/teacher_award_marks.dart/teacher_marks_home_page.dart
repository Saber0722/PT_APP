...
class TeacherMarksHomePage extends StatefulWidget {
  @override
  _TeacherMarksHomePageState createState() => _TeacherMarksHomePageState();
}

class _TeacherMarksHomePageState extends State<TeacherMarksHomePage> {
  ...
  Future<Map<String, dynamic>> fetchUserData() async {
    try {
      ...
      final QuerySnapshot querySnapshot = await firestore.collection('Teacher_Marks').get();
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [GestureDetector(onTap: (){Navigator.pushNamed(context, teacherHomePageRoute);},
              ...
              child: Column(
                ...
                children: [
                    ...
                    onPressed: () async {
                      ...
                      if (userData != null) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AddStudentMarksPage(),
                          ),
                        );
                      }
                    },
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(context,MaterialPageRoute(builder:(context)=>DeleteStudentMarksPage()));
                    },
                    child: Text(
                      'Delete Student Data',
                      style: TextStyle(fontSize: 18, color: Colors.white), // Change text color to white
