...
class DeleteStudentDataPage extends StatefulWidget {
  @override
  _DeleteStudentDataPageState createState() => _DeleteStudentDataPageState();
}

class _DeleteStudentDataPageState extends State<DeleteStudentDataPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream: firestore.collection('Teacher_Attendance').snapshots(),
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () async {
                ...
                await firestore.collection('Teacher_Attendance').doc(documentId).delete();
                // Close the dialog
