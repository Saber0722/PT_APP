...
class _TeacherAttendancePageState extends State<TeacherAttendancePage> {
  ...
  Future<Map<String, dynamic>> fetchUserData() async {
    try {
      ...
      final QuerySnapshot querySnapshot = await firestore.collection('Teacher_Attendance').get();
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.pushNamed(context,viewAttendancePageRoute);
                    },
                    child: Text(
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, deleteStudentAttendancePageRoute);
                    },
                    child: Text(
                      'Delete Student Data',
                      style: TextStyle(fontSize: 18, color: Colors.white), // Change text color to white
