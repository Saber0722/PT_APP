...
import 'package:modernlogintute/pages/Parent/attendance_page.dart';
import 'package:modernlogintute/pages/Student/view_attendance_page.dart';
...
import 'package:modernlogintute/pages/Student/view_marks_page.dart';

class StudentHomePage extends StatefulWidget {
  @override
  final String Mail;
  const StudentHomePage({required this.Mail});
...
class _StudentHomePageState extends State<StudentHomePage> {
  ...
  Future<Map<String, dynamic>> fetchUserData() async {
    try {
      ...
      final QuerySnapshot querySnapshot = await firestore.collection('Parent').get();
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(context,MaterialPageRoute(builder:
                       (context)=>StudentAttendancePage(enteredEmail: widget.Mail)));
                    },
                    child: Text(
                      'View Attendance',
                    ...
                    onPressed: () async {
                     ...
                     // Fetch the user data from Firestore
                      ...
                      if (userData != null) {
                       ...
                       Navigator.push(context,MaterialPageRoute(builder:
                       (context)=>StudentMarksPage(enteredEmail: widget.Mail)));
                      }
                    },
                    child: Text(
                      'View Marks',
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, uploadWorkPageRoute);
                    },
                    child: Text(
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.pushNamed(context, viewAssignmentPageRoute);
                    },
                    child: Text(
                      'View Assignment',
                      style: TextStyle(fontSize: 18, color: Colors.white), // Change text color to white
